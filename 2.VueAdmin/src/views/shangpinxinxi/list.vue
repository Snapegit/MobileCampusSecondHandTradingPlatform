		...
		<div class="app-contain">
				...
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.shangpinbiaoti" placeholder="商品标题"
								clearable>
							</el-input>
						</div>
					</div>
			...
			<el-table
				...
				<el-table-column
					...
					label="商品标题">
					<template #default="scope">
						{{scope.row.shangpinbiaoti}}
					</template>
				</el-table-column>
				<el-table-column
					 prop="shangpinchengse"
					 :resizable='true' 
					 :sortable='true' 
					 align="left" 
					 header-align="left"
...
<script setup>
	...
	const getList = () => {
		...
		params['sort'] = 'id'
		params['order'] = 'desc'
		if(searchQuery.value.shangpinbiaoti&&searchQuery.value.shangpinbiaoti!=''){
			params['shangpinbiaoti'] = '%' + searchQuery.value.shangpinbiaoti + '%'
		}
		context?.$http({
			url: `${tableName}/page`,
			method: 'get',
